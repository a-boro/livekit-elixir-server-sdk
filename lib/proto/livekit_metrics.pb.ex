...
defmodule Livekit.MetricsBatch do
  ...
  use Protobuf,
    full_name: "livekit.MetricsBatch",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.TimeSeriesMetric do
  ...
  use Protobuf,
    full_name: "livekit.TimeSeriesMetric",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.MetricSample do
  ...
  use Protobuf,
    full_name: "livekit.MetricSample",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.MetricsRecordingHeader.RoomTagsEntry do
  ...
  use Protobuf,
    full_name: "livekit.MetricsRecordingHeader.RoomTagsEntry",
    map: true,
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.MetricsRecordingHeader do
  ...
  use Protobuf,
    full_name: "livekit.MetricsRecordingHeader",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
