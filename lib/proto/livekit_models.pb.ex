...
defmodule Livekit.BackupCodecPolicy do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.BackupCodecPolicy",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataTrackExtensionID do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.DataTrackExtensionID",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ReconnectReason do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.ReconnectReason",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.SubscriptionError do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.SubscriptionError",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.AudioTrackFeature do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.AudioTrackFeature",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ParticipantInfo.Kind do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.ParticipantInfo.Kind",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ParticipantInfo.KindDetail do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.ParticipantInfo.KindDetail",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.Encryption.Type do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.Encryption.Type",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.VideoLayer.Mode do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.VideoLayer.Mode",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.OperationType do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.DataStream.OperationType",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.TokenPagination do
  ...
  use Protobuf,
    full_name: "livekit.TokenPagination",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.Room do
  ...
  use Protobuf, full_name: "livekit.Room", protoc_gen_elixir_version: "0.16.0", syntax: :proto3
...
defmodule Livekit.Codec do
  ...
  use Protobuf, full_name: "livekit.Codec", protoc_gen_elixir_version: "0.16.0", syntax: :proto3
...
defmodule Livekit.PlayoutDelay do
  ...
  use Protobuf,
    full_name: "livekit.PlayoutDelay",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ParticipantInfo.AttributesEntry do
  ...
  use Protobuf,
    full_name: "livekit.ParticipantInfo.AttributesEntry",
    map: true,
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataTrackInfo do
  ...
  use Protobuf,
    full_name: "livekit.DataTrackInfo",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataTrackExtensionParticipantSid do
  ...
  use Protobuf,
    full_name: "livekit.DataTrackExtensionParticipantSid",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataTrackSubscriptionOptions do
  ...
  use Protobuf,
    full_name: "livekit.DataTrackSubscriptionOptions",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.EncryptedPacket do
  ...
  use Protobuf,
    full_name: "livekit.EncryptedPacket",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.EncryptedPacketPayload do
  ...
  use Protobuf,
    full_name: "livekit.EncryptedPacketPayload",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.SipDTMF do
  ...
  use Protobuf, full_name: "livekit.SipDTMF", protoc_gen_elixir_version: "0.16.0", syntax: :proto3
...
defmodule Livekit.Transcription do
  ...
  use Protobuf,
    full_name: "livekit.Transcription",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.TranscriptionSegment do
  ...
  use Protobuf,
    full_name: "livekit.TranscriptionSegment",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.RpcAck do
  ...
  use Protobuf, full_name: "livekit.RpcAck", protoc_gen_elixir_version: "0.16.0", syntax: :proto3
...
defmodule Livekit.RTCPSenderReportState do
  ...
  use Protobuf,
    full_name: "livekit.RTCPSenderReportState",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.RTPForwarderState do
  ...
  use Protobuf,
    full_name: "livekit.RTPForwarderState",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.RTPMungerState do
  ...
  use Protobuf,
    full_name: "livekit.RTPMungerState",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.VP8MungerState do
  ...
  use Protobuf,
    full_name: "livekit.VP8MungerState",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.TextHeader do
  ...
  use Protobuf,
    full_name: "livekit.DataStream.TextHeader",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.ByteHeader do
  ...
  use Protobuf,
    full_name: "livekit.DataStream.ByteHeader",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.Header.AttributesEntry do
  ...
  use Protobuf,
    full_name: "livekit.DataStream.Header.AttributesEntry",
    map: true,
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.Header do
  ...
  use Protobuf,
    full_name: "livekit.DataStream.Header",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.Chunk do
  ...
  use Protobuf,
    full_name: "livekit.DataStream.Chunk",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.Trailer.AttributesEntry do
  ...
  use Protobuf,
    full_name: "livekit.DataStream.Trailer.AttributesEntry",
    map: true,
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.DataStream.Trailer do
  ...
  use Protobuf,
    full_name: "livekit.DataStream.Trailer",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.FilterParams do
  ...
  use Protobuf,
    full_name: "livekit.FilterParams",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.WebhookConfig do
  ...
  use Protobuf,
    full_name: "livekit.WebhookConfig",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.SubscribedAudioCodec do
  ...
  use Protobuf,
    full_name: "livekit.SubscribedAudioCodec",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
