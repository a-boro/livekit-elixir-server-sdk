...
defmodule Livekit.SegmentedFileSuffix do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.SegmentedFileSuffix",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ImageFileSuffix do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.ImageFileSuffix",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.EgressSourceType do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.EgressSourceType",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ParticipantEgressRequest do
  ...
  use Protobuf,
    full_name: "livekit.ParticipantEgressRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.AutoParticipantEgress do
  ...
  use Protobuf,
    full_name: "livekit.AutoParticipantEgress",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
