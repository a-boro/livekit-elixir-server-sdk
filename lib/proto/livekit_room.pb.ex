...
defmodule Livekit.UpdateParticipantRequest.AttributesEntry do
  ...
  use Protobuf,
    full_name: "livekit.UpdateParticipantRequest.AttributesEntry",
    map: true,
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.RoomConfiguration do
  ...
  use Protobuf,
    full_name: "livekit.RoomConfiguration",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ForwardParticipantRequest do
  ...
  use Protobuf,
    full_name: "livekit.ForwardParticipantRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ForwardParticipantResponse do
  ...
  use Protobuf,
    full_name: "livekit.ForwardParticipantResponse",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
end
...
defmodule Livekit.MoveParticipantRequest do
  ...
  use Protobuf,
    full_name: "livekit.MoveParticipantRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.MoveParticipantResponse do
  ...
  use Protobuf,
    full_name: "livekit.MoveParticipantResponse",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
end
...
defmodule Livekit.PerformRpcRequest do
  ...
  use Protobuf,
    full_name: "livekit.PerformRpcRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.PerformRpcResponse do
  ...
  use Protobuf,
    full_name: "livekit.PerformRpcResponse",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
