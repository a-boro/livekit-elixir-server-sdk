...
defmodule Livekit.WorkerStatus do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.WorkerStatus",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.Job do
  ...
  use Protobuf, full_name: "livekit.Job", protoc_gen_elixir_version: "0.16.0", syntax: :proto3
...
defmodule Livekit.WorkerMessage do
  ...
  use Protobuf,
    full_name: "livekit.WorkerMessage",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.ServerMessage do
  ...
  use Protobuf,
    full_name: "livekit.ServerMessage",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.SimulateJobRequest do
  ...
  use Protobuf,
    full_name: "livekit.SimulateJobRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.RegisterWorkerRequest do
  ...
  use Protobuf,
    full_name: "livekit.RegisterWorkerRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.RegisterWorkerResponse do
  ...
  use Protobuf,
    full_name: "livekit.RegisterWorkerResponse",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.MigrateJobRequest do
  ...
  use Protobuf,
    full_name: "livekit.MigrateJobRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.AvailabilityRequest do
  ...
  use Protobuf,
    full_name: "livekit.AvailabilityRequest",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.AvailabilityResponse.ParticipantAttributesEntry do
  ...
  use Protobuf,
    full_name: "livekit.AvailabilityResponse.ParticipantAttributesEntry",
    map: true,
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.AvailabilityResponse do
  ...
  use Protobuf,
    full_name: "livekit.AvailabilityResponse",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.UpdateJobStatus do
  ...
  use Protobuf,
    full_name: "livekit.UpdateJobStatus",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.UpdateWorkerStatus do
  ...
  use Protobuf,
    full_name: "livekit.UpdateWorkerStatus",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.JobAssignment do
  ...
  use Protobuf,
    full_name: "livekit.JobAssignment",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.JobTermination do
  ...
  use Protobuf,
    full_name: "livekit.JobTermination",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
