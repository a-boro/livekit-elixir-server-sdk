...
defmodule Livekit.IngressAudioEncodingPreset do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.IngressAudioEncodingPreset",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.IngressVideoEncodingPreset do
  ...
  use Protobuf,
    enum: true,
    full_name: "livekit.IngressVideoEncodingPreset",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.IngressAudioEncodingOptions do
  ...
  use Protobuf,
    full_name: "livekit.IngressAudioEncodingOptions",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Livekit.IngressVideoEncodingOptions do
  ...
  use Protobuf,
    full_name: "livekit.IngressVideoEncodingOptions",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
